...
print("Cumple minimos TOTAL:", Counter([r['cumple'] for r in resultados]))
print("Form completo TOTAL:", Counter([r['form'] for r in resultados]))
si_forms = [r for r in resultados if r['form'] == 'SI']
print("Cumple minimos (Solo Form SI):", Counter([r['cumple'] for r in si_forms]))
print("Rutas (Solo Form SI y Cumple):", Counter([r['ruta'] for r in si_forms if r['cumple'] == 'Cumple mínimos']))
