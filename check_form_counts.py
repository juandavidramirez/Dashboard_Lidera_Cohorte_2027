...
form_completo_vals = {}
for d in data:
    val = str(d.get('form_completo')).strip().upper()
    form_completo_vals[val] = form_completo_vals.get(val, 0) + 1
print("Current form_completo breakdown in DB:", form_completo_vals)
